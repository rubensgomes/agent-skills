...
- Added new refresh-session skill
...
- Normalized three code fences in
  `skills/ai-license-readme/README_TEMPLATE.md` that closed with four backticks
  instead of three.
...
- Fixed typos and table in skill doc.
