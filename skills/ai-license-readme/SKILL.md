...
description: >-
  ...
  updates or creates a README.md file with references to these files and 
  Markdown badges.
...
6. At the top of the README, include Markdown badges and an "AI Disclaimer"
...
7. Near the end of the file, include "Authorship" and "License" sections like
...
8. Ensure that the "Authorship" section has the correct URL of the original
